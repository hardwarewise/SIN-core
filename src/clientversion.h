...
#error Client version information missing: version is not defined by sin-config.h or in any other way
#endif
...
/**
 * sind-res.rc includes this file, but it cannot cope with real c++ code.
