#include "sinpushbutton.h"
#include <QStylePainter>

SinPushButton::SinPushButton(QWidget *parent):
    QPushButton(parent),
    m_iconCached(false)
{}

SinPushButton::SinPushButton(const QString &text, QWidget *parent):
    QPushButton(text, parent),
    m_iconCached(false)
{}

void SinPushButton::paintEvent(QPaintEvent *)
{
...
void SinPushButton::updateIcon(QStyleOptionButton &pushbutton)
{
    // Update sunken icon
