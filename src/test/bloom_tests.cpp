...
{
    std::string strSecret = std::string("VG6SHv45rtyiGhnC1F7QRsy6qsuLvGjqHmYZzG8mG82maS5fuVrr");
...
BOOST_AUTO_TEST_CASE(merkle_block_1)
{
    ...
    filter.insert(uint256S("0x18e2c8cd1288ac3d6c9909d8d618a9f7a183587d3e8bc735b621b25ae0b76780"));
    ...
    BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("0x18e2c8cd1288ac3d6c9909d8d618a9f7a183587d3e8bc735b621b25ae0b76780"));
    ...
    filter.insert(uint256S("0xbfad2b62dc62533b5440c5c069de8cc36684e74f74770d131a49f2cb05e35955"));
    ...
    BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("0xbfad2b62dc62533b5440c5c069de8cc36684e74f74770d131a49f2cb05e35955"));
...
{
    // Random real block (e69ec8a32527cafe56519b3627b785555d2d27746b76749a8fbd627c320f6732)
    // With 4 txes
    CBlock block;
    CDataStream stream(ParseHex(""), SER_NETWORK, PROTOCOL_VERSION);
    stream >> block;

    CBloomFilter filter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    // Match the first transaction
    filter.insert(uint256S("0x2449496c194ca30440954218a711615e1a871f4e51d4981aa43e5c942c3fe73c"));
    ...
    BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("0x2449496c194ca30440954218a711615e1a871f4e51d4981aa43e5c942c3fe73c"));
...
BOOST_AUTO_TEST_CASE(rolling_bloom)
{
    ...
    // Run test_sin with --log_level=message to see BOOST_TEST_MESSAGEs:
