 ...
 */
static int secp256k1_schnorr_verify_batch_init_randomizer(const secp256k1_context *ctx, secp256k1_schnorr_verify_ecmult_context *ecmult_context, secp256k1_sha256_t *sha, const secp256k1_schnorr *const *sig, const unsigned char *const *msg32, const secp256k1_pubkey *const *pk, size_t n_sigs) {
    size_t i;
