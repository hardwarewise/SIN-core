...
/** Giaki3003 notes: as of now, these are only used for zkp secp256k1 parts of 
    the lib we use, so keeping both windows seems rational as moving to a 
    submodule based approach in the future is an option */
#ifdef USE_ENDOMORPHISM
