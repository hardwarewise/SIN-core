...
# TestP2PConn: A peer we use to send messages to sind, and store responses.
...
class CompactBlocksTest(SinTestFramework):
    ...
    # This test actually causes sind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that sind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for sind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # sind will not send blocktxn responses for blocks whose height is
