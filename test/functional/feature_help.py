...
"""Verify that starting sin with -h works as expected."""

from test_framework.test_framework import SinTestFramework
from test_framework.util import assert_equal

class HelpTest(SinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start sin with -h for help text")
        ...
        self.log.info("Start sin with -version for version information")
        ...
        self.log.info("Start sind with -fakearg to make sure it does not start")
